...
function createGift() {
  ...
  const messages = [
    '🎁 Mong em chân cứng đá mềm trên đoạn đường sắp tới ',
    '🎄 Chúc em thời gian sắp tới sẽ tươi vui và ngập tràn hạnh phúc',
    '⭐  Chúc Thu Thỏ giáng sinh an lành',
    '🎅 ho ho ho ta là ông già noel đây ta có thể thực hiện một điều ước từ em',
  ];
